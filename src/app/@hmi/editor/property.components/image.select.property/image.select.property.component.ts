...
export class ImageSelectPropertyComponent extends BasicPropertyComponent<any> {
  ...
  public constructor(protected injector: Injector) {
    super(injector);
    this.nullValue = '';
    this.images.push('/assets/imgs/default_device.png');

    this.images.push('/assets/imgs/logo.webp');

    this.images.push('/assets/imgs/test.png');

    this.images.push('/assets/imgs/texture.png');

    this.images.push('/assets/imgs/work.area.png');
